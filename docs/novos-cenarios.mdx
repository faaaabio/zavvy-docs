...
O bloco BASE completo está em [Referência Visual → Prompt base reutilizável](/docs/referencia-visual#prompt-base-reutilizável). Cole-o no início de cada prompt antes de adicionar o ambiente e a ação.
